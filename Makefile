...
ACLOCAL = ${SHELL} /root/openvpn-2.3.10/missing aclocal-1.14
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AS = as
AUTOCONF = ${SHELL} /root/openvpn-2.3.10/missing autoconf
AUTOHEADER = ${SHELL} /root/openvpn-2.3.10/missing autoheader
AUTOMAKE = ${SHELL} /root/openvpn-2.3.10/missing automake-1.14
AWK = gawk
CC = gcc
...
LZO_CFLAGS = 
LZO_LIBS = -llzo2
MAKEINFO = ${SHELL} /root/openvpn-2.3.10/missing makeinfo
MAN2HTML = man2html
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NETSTAT = netstat
...
TAP_WIN_MIN_MINOR = 9
VERSION = 2.3.10
abs_builddir = /root/openvpn-2.3.10
abs_srcdir = /root/openvpn-2.3.10
abs_top_builddir = /root/openvpn-2.3.10
abs_top_srcdir = /root/openvpn-2.3.10
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/openvpn-2.3.10/install-sh
